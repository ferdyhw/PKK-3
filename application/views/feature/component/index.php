  ...
  <div class="container">
    ...
    <div class="row d-flex justify-content-center">
      ...
      <!-- Blog Entries Column -->
      <div class="col-md-9">
        <h2 style="margin-top: 85px; margin-bottom: 20px"><span style="color: #f8c02d">|</span> Component</h2>

        <!-- Blog Post -->
        <div class="card mb-4">
          <img class="card-img-top" src="<?= base_url('assets/img/component/') . $content1['thumbnail']; ?>" alt="Card image cap">
          <div class="card-body">
            <h2 class="card-title"><?= $content1['title'] ?></h2>
            <p class="card-text"><?= $content1['summary'] ?></p>
            <a href="<?= base_url('component/page_1') ?>" class="btn btn-info">Read More &rarr;</a>
          </div>
        ...
        <!-- Blog Post -->
        <div class="card mb-4">
          <img class="card-img-top" src="<?= base_url('assets/img/component/') . $content2['thumbnail']; ?>" alt="Card image cap">
          <div class="card-body">
            <h2 class="card-title"><?= $content2['title'] ?></h2>
            <p class="card-text"><?= $content2['summary'] ?></p>
            <a href="<?= base_url('component/page_2') ?>" class="btn btn-info">Read More &rarr;</a>
          </div>
          <div class="card-footer text-muted">
        ...
        <!-- Blog Post -->
        <div class="card mb-4">
          <img class="card-img-top" src="<?= base_url('assets/img/component/') . $content3['thumbnail']; ?>" alt="Card image cap">
          <div class="card-body">
            <h2 class="card-title"><?= $content3['title'] ?></h2>
            <p class="card-text"><?= $content3['summary'] ?></p>
            <a href="<?= base_url('component/page_3') ?>" class="btn btn-info">Read More &rarr;</a>
          </div>
          <div class="card-footer text-muted">
