  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <!-- Preview Image -->
        <img class="container" src="<?= base_url('assets/img/project/') . $project['picture']; ?>">

        <hr>

        <!-- Post Content -->
        <div style="font-family: Arial; text-align: justify;">
        <h4 class="py-2"><span class="text-info">|</span> Deskripsi</h4>
        <p class="lead"><?= $project['content'] ?></p>        
        </div>

        <h4 class="py-2"><span class="text-info">|</span> Rangkaian</h4>
        <img class="container" style="max-width: 500px" src="<?= base_url('assets/img/project/') . $project['rangkaian']; ?>">

        <h4 class="py-2"><span class="text-info">|</span> Kode Program</h4>
        <p class="lead"><pre class="prettyprint p-2 bg-light" style="border: 0.9px solid gray; border-radius: 2px; overflow: scroll; height: 500px"><?= $project['program'] ?></pre></p>
        ...
        <ul class="pagination justify-content-center mb-4">
          <li class="page-item">
            <a class="page-link" href="<?= base_url('project/page_1') ?>">&laquo; Prev</a>
          </li>
          <li class="page-item">
            <a class="page-link" href="<?= base_url('project/page_3') ?>">Next &raquo;</a>
          </li>
        </ul>
