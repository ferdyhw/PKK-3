            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Feature Quiz</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="<?= base_url('dashboard/admin') ?>">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="<?= base_url('feature/edit_quiz') ?>">Quiz</a></li>
                            <li class="breadcrumb-item active">Quiz Page 2</li>
                        </ol>
                        <?= $this->session->flashdata('pesan'); ?>
                        <a href="<?= base_url('quiz/soal_quiz_2') ?>"><button class="badge badge-primary py-2 mb-2"><i class="fas fa-pen"></i> Edit Soal</button></a>
                        <h4>Edit Quiz Page 2</h4>
                        <div class="card mb-4">
                            <div class="card-body">
                                <form action="" method="post" enctype="multipart/form-data">
                                    <input type="text" name="id_quiz" value="<?= $quiz['id'] ?>" hidden></input>

                                    <div class="form-group"><label class="small mb-1" for="title">Title Content</label><input class="form-control" id="title" name="title" type="text" placeholder="Masukan Judul Content" value="<?= $quiz['title'] ?>" /></input><small class="text-danger"><?= form_error('title'); ?></small></div>

                                    <div class="form-group"><label class="small mb-1" for="summary">Summary</label><textarea  class="ckeditor" id="ckedtor" name="summary" type="text" placeholder="Masukan summary"/><?= $quiz['summary'] ?></textarea><small class="text-danger"><?= form_error('summary'); ?></small></div>
                                    ...
                                    <label for="email" class="small">Picture Content</label>
                                                <div class="custom-file mt-0">
                                                  ...
                                                  <img class="img-thumbnail mt-1" class="mt-2" src="<?= base_url('assets/img/quiz/') . $quiz['picture']; ?>"></img>

                                    <div class="form-group"><label class="small mb-1" for="author">Author Content</label><input class="form-control" id="author" name="author" type="text" placeholder="Masukan Author Content" value="<?= $quiz['author'] ?>" /></input><small class="text-danger"><?= form_error('author'); ?></small></div>


                                    <div class="form-group"><label class="small mb-1" for="date">Date Content</label><input class="form-control" id="date" name="date" type="date" placeholder="Masukan Date Content" value="<?= $quiz['date'] ?>" /></input><small class="text-danger"></small></div>
