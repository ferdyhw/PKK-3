                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-2">
                            ...
                            <li class="breadcrumb-item active">Quiz Page 1</li>
                        </ol>
                        <?= $this->session->flashdata('pesan'); ?>
                        <a href="<?= base_url('quiz/soal_quiz_1') ?>"><button class="badge badge-primary py-2 mb-2"><i class="fas fa-pen"></i> Edit Soal</button></a>
                        <h4>Edit Quiz Page 1</h4>
                        <div class="card mb-4">
                            <div class="card-body">
