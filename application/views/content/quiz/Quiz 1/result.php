  ...
  <div class="container">
    ...
    <div class="row d-flex justify-content-center">
      ...
      <div class="col-md-12">
        ...
        <h1 class="my-5 text-info">|  <span class="text-dark">Result Quiz</span>
        </h1>

        <div style="padding: 20px; margin-bottom: 97px; background-color: white; border: 2px solid #ddd5d5">
            ...
            <?php
                  ...
                  for ($i=0;$i<$jumlah;$i++){
                    ...
                    if (empty($pilihan[$nomor])){
                      ...
                      $query=mysqli_query($conn, "SELECT * FROM soal WHERE id='$nomor' AND jawaban='$jawaban'");
                    ...
                    */
                    ...
                    $result=mysqli_query($conn, "SELECT * FROM soal WHERE id_quiz='1'");
                ...
                echo "<h3 style='border:0';>Nilai Quiz Basic <u>$username</u> :</h3>";
                ...
                echo "<tr><td><h5>Nilai Akhir            </td><td>: $hasil</h5></td>";
                ?>
        </div>
   		</div>
	</div>
