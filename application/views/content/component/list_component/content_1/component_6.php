            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Component 6</h1>
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Edit Component 6</li>
                        </ol>
                        <?= $this->session->flashdata('pesan'); ?>
                        <div class="card mb-4">          
                          <div class="card-body">
                            <h4>Edit Component 6</h4>
                            <form action="<?= base_url('component/component_6') ?>" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <input type="text" name="id" value="<?= $component['id'] ?>" hidden></input>                                        
                                            <label for="title_6" class="small">Nama</label>
                                            <input type="title_6" class="form-control" name="title_6" id="title_6" value="<?= $component['title_6'] ?>">
                                            ...
                                            <label for="link_6" class="small">Link</label>
                                            <input type="link_6" class="form-control" name="link_6" id="link_6" value="<?= $component['link_6'] ?>">

                                            <label class="small mb-1" for="desc_6">Deskripsi</label><textarea class="ckeditor" id="desc_6" name="desc_6" type="text"/><?= $component['desc_6'] ?></textarea><small class="text-danger"><?= form_error('desc_6'); ?></small>

                                            <label for="gambar" class="small">Gambar</label>
                                            <div class="custom-file mt-0">
                                                <input type="file" class="custom-file-input" name="picture_6" id="customFile">
                                                <label class="custom-file-label" for="customFile">Pilih Gambar</label>
                                                <img class="img-thumbnail mt-2 mb-2" style="max-width: 100%; height: auto;" class="mt-2" src="<?= base_url('assets/img/component/comp_1/') . $component['picture_6']; ?>"></img>
