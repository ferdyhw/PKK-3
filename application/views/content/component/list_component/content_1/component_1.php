            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Component 1</h1>
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="<?= base_url('component/edit_page_1') ?>">Component Page 1</a></li>
                            <li class="breadcrumb-item"><a href="<?= base_url('component/edit_component_1') ?>">Edit Component</a></li>
                            <li class="breadcrumb-item active">Edit Component 1</li>
                        </ol>
                        <?= $this->session->flashdata('pesan'); ?>
                        <div class="card mb-4">          
                          <div class="card-body">
                            <h4>Edit Component 1</h4>
                            <form action="<?= base_url('component/component_1') ?>" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <input type="text" name="id" value="<?= $component['id'] ?>" hidden></input>                                        
                                            <label for="title_1" class="small">Nama</label>
                                            <input type="title_1" class="form-control" name="title_1" id="title_1" value="<?= $component['title_1'] ?>">
                                            ...
                                            <label for="link_1" class="small">Link</label>
                                            <input type="link_1" class="form-control" name="link_1" id="link_1" value="<?= $component['link_1'] ?>">

                                            <label class="small mb-1" for="desc_1">Deskripsi</label><textarea class="ckeditor" id="desc_1" name="desc_1" type="text"/><?= $component['desc_1'] ?></textarea><small class="text-danger"><?= form_error('desc_1'); ?></small>

                                            <label for="gambar" class="small">Gambar</label>
                                            <div class="custom-file mt-0">
                                                <input type="file" class="custom-file-input" name="picture_1" id="customFile">
                                                <label class="custom-file-label" for="customFile">Pilih Gambar</label>
                                                <img class="img-thumbnail mt-2 mb-2" style="max-width: 100%; height: auto;" class="mt-2" src="<?= base_url('assets/img/component/comp_1/') . $component['picture_1']; ?>"></img>
