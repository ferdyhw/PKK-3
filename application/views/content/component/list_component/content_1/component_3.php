            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Component 3</h1>
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Edit Component 3</li>
                        </ol>
                        <?= $this->session->flashdata('pesan'); ?>
                        <div class="card mb-4">          
                          <div class="card-body">
                            <h4>Edit Component 4</h4>
                            <form action="<?= base_url('component/component_3') ?>" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <input type="text" name="id" value="<?= $component['id'] ?>" hidden></input>                                        
                                            <label for="title_3" class="small">Nama</label>
                                            <input type="title_3" class="form-control" name="title_3" id="title_3" value="<?= $component['title_3'] ?>">
                                            ...
                                            <label for="link_3" class="small">Link</label>
                                            <input type="link_3" class="form-control" name="link_3" id="link_3" value="<?= $component['link_3'] ?>">

                                            <label class="small mb-1" for="desc_3">Deskripsi</label><textarea class="ckeditor" id="desc_3" name="desc_3" type="text"/><?= $component['desc_3'] ?></textarea><small class="text-danger"><?= form_error('desc_3'); ?></small>

                                            <label for="gambar" class="small">Gambar</label>
                                            <div class="custom-file mt-0">
                                                <input type="file" class="custom-file-input" name="picture_3" id="customFile">
                                                <label class="custom-file-label" for="customFile">Pilih Gambar</label>
                                                <img class="img-thumbnail mt-2 mb-2" style="max-width: 100%; height: auto;" class="mt-2" src="<?= base_url('assets/img/component/comp_1/') . $component['picture_3']; ?>"></img>
