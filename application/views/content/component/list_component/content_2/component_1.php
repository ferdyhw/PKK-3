                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">          
                          <div class="card-body">
                            ...
                            <form action="<?= base_url('component/component_7') ?>" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <input type="text" name="id" value="<?= $component['id'] ?>" hidden></input>                                        
                                            ...
                                            <div class="custom-file mt-0">
                                                ...
                                                <img class="img-thumbnail mt-2 mb-2" style="max-width: 100%; height: auto;" class="mt-2" src="<?= base_url('assets/img/component/comp_2/') . $component['picture_1']; ?>"></img>
