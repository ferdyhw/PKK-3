    ...
    <div class="row">
      ...
      <div class="col-lg-12">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-toggle="modal" data-target="#modal1">
                                ...
                                <img class="img-fluid" src="<?= base_url('/assets/img/component/comp_3/') . $comp_1['picture_1'] ?>" alt="" />
                            </a>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-toggle="modal" data-target="#modal2">
                                ...
                                <img class="img-fluid" src="<?= base_url('/assets/img/component/comp_3/') . $comp_2['picture_2'] ?>" alt="" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-toggle="modal" data-target="#modal3">
                                ...
                                <img class="img-fluid" src="<?= base_url('/assets/img/component/comp_3/') . $comp_3['picture_3'] ?>" alt="" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-toggle="modal" data-target="#modal4">
                                ...
                                <img class="img-fluid" src="<?= base_url('/assets/img/component/comp_3/') . $comp_4['picture_4'] ?>" alt="" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-toggle="modal" data-target="#modal5">
                                ...
                                <img class="img-fluid" src="<?= base_url('/assets/img/component/comp_3/') . $comp_5['picture_5'] ?>" alt="" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-toggle="modal" data-target="#modal6">
                                ...
                                <img class="img-fluid" src="<?= base_url('/assets/img/component/comp_3/') . $comp_6['picture_6'] ?>" alt="" />
                            </a>
                            <div class="portfolio-caption">
        ...
        <ul class="pagination justify-content-center mb-4">
          <li class="page-item">
            <a class="page-link" href="<?= base_url('component/page_2') ?>">&laquo; Prev</a>
          </li>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <!-- Project Details Go Here-->                                                
                            <img class="img-fluid d-block mx-auto mb-3" src="<?= base_url('/assets/img/component/comp_3/') . $comp_1['picture_1'] ?>" alt="" />
                ...
                <div class="modal fade" id="modal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <!-- Project Details Go Here-->                                                
                            <img class="img-fluid d-block mx-auto mb-3" src="<?= base_url('/assets/img/component/comp_3/') . $comp_2['picture_2'] ?>" alt="" />
                ...
                <div class="modal fade" id="modal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <!-- Project Details Go Here-->                                                
                            <img class="img-fluid d-block mx-auto mb-3" src="<?= base_url('/assets/img/component/comp_3/') . $comp_3['picture_3'] ?>" alt="" />
                ...
                <div class="modal fade" id="modal4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <!-- Project Details Go Here-->                                                
                            <img class="img-fluid d-block mx-auto mb-3" src="<?= base_url('/assets/img/component/comp_3/') . $comp_4['picture_4'] ?>" alt="" />
                ...
                <div class="modal fade" id="modal5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <!-- Project Details Go Here-->                                                
                            <img class="img-fluid d-block mx-auto mb-3" src="<?= base_url('/assets/img/component/comp_3/') . $comp_5['picture_5'] ?>" alt="" />
                ...
                <div class="modal fade" id="modal6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <!-- Project Details Go Here-->                                                
                            <img class="img-fluid d-block mx-auto mb-3" src="<?= base_url('/assets/img/component/comp_3/') . $comp_6['picture_6'] ?>" alt="" />
