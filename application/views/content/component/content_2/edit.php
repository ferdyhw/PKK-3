                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-2">
                            ...
                            <li class="breadcrumb-item active">Component Page 2</li>
                        </ol>
                        <?= $this->session->flashdata('pesan'); ?>
                        <a href="<?= base_url('component/edit_component_2') ?>"><button class="badge badge-primary py-2 mb-2"><i class="fas fa-pen"></i> Edit Component</button></a>
                        <h4>Edit Component 2</h4>
                        <div class="card mb-4">
                            <div class="card-body">
